"use strict";(self.webpackChunkdumi_test=self.webpackChunkdumi_test||[]).push([[236],{71236:function(Qn,_,u){u.r(_),u.d(_,{AutoLoadingButton:function(){return yn},PuzzleCaptcha:function(){return kn}});var gn=u(57213),c=u.n(gn),hn=u(54306),L=u.n(hn),pn=u(12342),xn=u.n(pn),mn=u(58338),b=u(85170),v=u(43010),bn=["children","onClick"],yn=function(){var o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},r=o.children,e=o.onClick,f=xn()(o,bn),n=(0,b.useState)(!1),h=L()(n,2),x=h[0],A=h[1],C=function(y){return!!(y&&y.then)},P=function(){if(typeof e=="function"){var y=e();y&&C(y)&&(A(!0),y.then(function(){A(!1)},function(Z){return A(!1),Promise.reject(Z)}))}};return(0,v.jsx)(mn.ZP,c()(c()({},f),{},{loading:x,onClick:P,children:r}))},wn=u(25359),j=u.n(wn),Mn=u(49811),W=u.n(Mn),zn=u(84875),E=u.n(zn),nn=function(r){return new Promise(function(e){setTimeout(function(){e(!0)},r)})},jn=navigator.userAgent.indexOf("Firefox")>=0&&navigator.userAgent.indexOf("Windows")>=0,d=function(r,e){return Math.ceil(Math.random()*(e-r)+r)},Tn=function(r,e){var f=document.createElement("canvas"),n=f.getContext("2d");if(!n)return"";f.width=r,f.height=e,n.fillStyle=`rgb(
    `.concat(d(100,255),`,
    `).concat(d(100,255),`,
    `).concat(d(100,255),`
      ...
      `).concat(d(100,255),`,
      `).concat(d(100,255),`
    )`),d(0,2)>1)n.save(),n.rotate(d(-90,90)*Math.PI/180),n.fillRect(d(-20,f.width-20),d(-20,f.height-20),d(10,f.width/2+10),d(10,f.height/2+10)),n.restore();else{n.beginPath();var x=d(-Math.PI,Math.PI);n.arc(d(0,f.width),d(0,f.height),d(10,f.height/2+10),x,x+Math.PI*1.5),n.closePath(),n.fill()}return f.toDataURL("image/png")},An=function(r,e,f){return{x:d(f+20,r-f-20),y:d(20,e-f-20)}},B=function(r,e,f){if(r){var n=f/4,h=n/2;r.beginPath(),r.moveTo(e.x,e.y),r.lineTo(e.x+n,e.y),r.arcTo(e.x+n,e.y-h,e.x+n+h,e.y-h,h),r.arcTo(e.x+n+n,e.y-n/2,e.x+n+n,e.y,n/2),r.lineTo(e.x+n+n+n,e.y),r.lineTo(e.x+n+n+n,e.y+n),r.arcTo(e.x+n+n+n+n/2,e.y+n,e.x+n+n+n+n/2,e.y+n+n/2,n/2),r.arcTo(e.x+n+n+n+n/2,e.y+n+n,e.x+n+n+n,e.y+n+n,n/2),r.lineTo(e.x+n+n+n,e.y+n+n+n),r.lineTo(e.x,e.y+n+n+n),r.lineTo(e.x,e.y+n+n),r.arcTo(e.x+n/2,e.y+n+n,e.x+n/2,e.y+n+n/2,n/2),r.arcTo(e.x+n/2,e.y+n,e.x,e.y+n,n/2),r.lineTo(e.x,e.y),r.closePath()}},Cn=u(92935),Sn=u.n(Cn),Rn=u(75177),en,Gn=Rn.zo.section(en||(en=Sn()([`
